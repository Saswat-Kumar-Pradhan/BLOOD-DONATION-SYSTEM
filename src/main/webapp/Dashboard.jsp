...
<BR>
- Conditions that are acceptable<BR>
- Conditions that require temporary deferral for defined periods of time<BR>
- Conditions that require permanent deferral<BR>
- Conditions that require individual assessment.</h3>
<br><br><br><BR><BR><center>
    <h1>DONOR APPEARANCE AND INSPECTION</h1><br><br><br></center>
    <h3>The prospective donor should appear generally well and should not be febrile, breathless or suffering from a persistent cough. Donors should be observed to rule out malnutrition or any debilitating condition. They should have a sound mental status and not be under the influence of alcohol or drugs.
...
<BR>
Recommendation<BR>
- Prospective donors should be accepted only if they appear to be in good health and comply with donor selection criteria</h3>
<br><br><br><BR><BR><center>
    <h1>MINOR ILLNESSES</h1><br><br><br></center>
    <h3>Minor non-specific symptoms (e.g. general malaise, pain, fever, headache, cough, diarrhoea) may indicate the presence of an acute infection that may be transmissible by transfusion. Donors should be asked to confirm that they are free from such symptoms on the day of donation and that they have fully recovered from any recent infection(s). Individuals suffering from minor illnesses and not feeling well should not donate blood.

There is no evidence that minor infections such as common upper respiratory infections can be transmitted by transfusion, but it is nevertheless advisable as a precautionary measure to defer blood donation until any such infection has resolved (65).<BR>
Recommendation<BR>
- Individuals with a history of recent infection: defer for 14 days following full recovery and cessation of any therapy, including antibiotics</h3>
